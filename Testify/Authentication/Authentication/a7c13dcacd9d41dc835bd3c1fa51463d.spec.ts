...
const stepsFromInput = [
  ...
  },
  {
    ...
    "retry": 3,
    "fallbacks": ["waitForLoadState"],
    "errorMessage": "Failed to fill in the username",
    "stepDescription": "Enter 'standard_user' in the input field with data-test attribute 'username'"
  },
  {
    "action": "fill",
    ...
    "retry": 3,
    "fallbacks": ["waitForLoadState"],
    "errorMessage": "Failed to fill in the password",
    "stepDescription": "Enter 'secret_sauce' in the input field with data-test attribute 'password'"
  },
  {
    "action": "click",
    ...
    "stepDescription": "Click the input element with data-test attribute 'login-button' and type 'submit'"
  }
];
...
test('Generated Test', async () => {
  ...
  try {
    ...
    try {
      require('fs').writeFileSync('a7c13dcacd9d41dc835bd3c1fa51463d.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
