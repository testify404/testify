...
test('Generated Test', async () => {
  ...
  const originalUserSteps: string[] = [
    ...
    "Enter 'standard_user' into input with id 'user-name'",
    "Enter 'secret_sauce' into input with id 'password'",
    "Click input with id 'login-button'"
  ];
  ...
  try {
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "stepDescription": "Enter 'standard_user' into input with id 'user-name'"
        },
        {
          "action": "fill",
          "selector": "#password",
          ...
          "stepDescription": "Enter 'secret_sauce' into input with id 'password'"
        },
        {
          "action": "click",
          ...
          "stepDescription": "Click input with id 'login-button'"
        }
      ];
    ...
    try {
      require('fs').writeFileSync('3056fe3207514e83868b63ccae91e956.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
