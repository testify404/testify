  ...
  try {
    ...
    if (!setupError && page) {
      const steps = [
        ...
        {
          "action": "click",
          "selector": "[value='za'].product_sort_container",
          "value": null,
          "waitTimeoutMs": 5000,
          "retry": 3,
          "fallbacks": [],
        ...
        },
        {
          ...
          "stepDescription": "Enter the first name as chaitanya"
        },
        {
          "action": "fill",
          "selector": "#last-name",
          ...
          "stepDescription": "Enter the last name as Kompella"
        },
        {
          "action": "fill",
          ...
          "stepDescription": "Enter the postal code as 62567352"
        },
        {
          "action": "click",
          "selector": "#continue",
        ...
        },
        {
          ...
          "stepDescription": "Verify the message 'Thank you for your order!'"
        },
        {
          "action": "click",
    ...
    try {
      require('fs').writeFileSync('f0ab1f58df624f238bc93f44fe63bc42.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
