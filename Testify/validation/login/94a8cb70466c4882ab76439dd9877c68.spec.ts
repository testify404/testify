...
test('Generated Test', async () => {
  ...
  try {
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "stepDescription": "Assert that the product \"Sauce Labs Backpack\" is present in the cart with data-test attribute \"inventory-item-name\"."
        },
        {
          "action": "click",
          "selector": "#checkout",
        ...
        },
        {
          ...
          "stepDescription": "Assert that the message \"Thank you for your order!\" is displayed with class \"complete-header\"."
        },
        {
          "action": "click",
        ...
        },
        {
          ...
          "stepDescription": "Click the burger bar with id \"react-burger-menu-btn\"."
        },
        {
          "action": "click",
    ...
    try {
      require('fs').writeFileSync('94a8cb70466c4882ab76439dd9877c68.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
