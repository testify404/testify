...
test('Generated Test', async () => {
  ...
  const steps = [
    ...
    {
      "action": "isVisible",
      "selector": ".cart_item .inventory_item_name[data-test='inventory-item-name']:has-text('Sauce Labs Backpack')",
      "value": null,
      "waitTimeoutMs": 10000,
      "retry": 3,
      "fallbacks": ["scrollIntoView"],
    ...
    },
    {
      ...
      "retry": 3,
      "fallbacks": ["scrollIntoView"],
      "errorMessage": "The 'Thank you for your order!' message is not visible",
  ...
  try {
    ...
    try {
      fs.writeFileSync('b2bcf4904ff54dbf9222c50affe57126.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
