...
const analyze_playwright_input = {
  "normalized_steps": [
    ...
    "Click the button with data-test attribute 'login-button'"
  ]
};
...
test('Generated Test', async () => {
  ...
  const originalUserSteps: string[] = analyze_playwright_input.normalized_steps;
  ...
  try {
    ...
    try {
      require('fs').writeFileSync('9e9a8e95fad14d789f9d2d7090573ef1.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
    }
