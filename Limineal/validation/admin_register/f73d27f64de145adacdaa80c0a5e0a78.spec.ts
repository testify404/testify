...
test('Generated Test', async () => {
  ...
  try {
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "stepDescription": "Select Name (Z to A) from the sort dropdown with value 'za'."
        },
        {
          "action": "click",
        ...
        },
        {
          ...
          "stepDescription": "Enter the first name as dharanesh in the first name field with id 'first-name'."
        },
        {
          "action": "fill",
          "selector": "#last-name",
    ...
    try {
      fs.writeFileSync('f73d27f64de145adacdaa80c0a5e0a78.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
