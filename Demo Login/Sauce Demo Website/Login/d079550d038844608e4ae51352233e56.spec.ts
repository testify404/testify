...
test('Generated Test', async () => {
  ...
  const originalUserSteps: string[] = [
    ...
    "Click the button with data-test attribute 'login-button' and value 'Login'"
  ];
  ...
  try {
    ...
    try {
      require('fs').writeFileSync('d079550d038844608e4ae51352233e56.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
    }
